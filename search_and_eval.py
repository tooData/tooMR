...
if __name__ == "__main__": 
    ...
    #corrigez les 5 lignes pour bien importer les fonctions et faire fonctionner le tout
    ...
    #tests    
    """
    Sortir les résultats pour 10 requêtes au hasard  depuis queries_df
    ...
    """ 
    Sortir le rappel@3 et précision@3 pour 10 requêtes au hasard depuis queries_df
    """
    ...
    """ 
    Sortir l'average precision pour 10 requêtes au hasard depuis queries_df
    """
